    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'zrobot_interfaces.msg.MotorCommand')
            logger.debug(
...
class MotorCommand(metaclass=Metaclass_MotorCommand):
    ...
    def __init__(self, **kwargs):
        ...
        self.motors_running = kwargs.get('motors_running', bool())
    ...
    def __eq__(self, other):
        ...
        if self.right_speed != other.right_speed:
            return False
        if self.motors_running != other.motors_running:
            return False
    ...
    def motors_running(self):
        """Message field 'motors_running'."""
        return self._motors_running

    @motors_running.setter
    def motors_running(self, value):
        if self._check_fields:
            assert \
                isinstance(value, bool), \
                "The 'motors_running' field must be of type 'bool'"
        self._motors_running = value
