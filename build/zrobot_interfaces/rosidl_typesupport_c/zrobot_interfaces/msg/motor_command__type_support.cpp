...
static const _MotorCommand_type_support_symbol_names_t _MotorCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, zrobot_interfaces, msg, MotorCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, zrobot_interfaces, msg, MotorCommand)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, zrobot_interfaces, msg, MotorCommand)() {
  return &::zrobot_interfaces::msg::rosidl_typesupport_c::MotorCommand_message_type_support_handle;
}
