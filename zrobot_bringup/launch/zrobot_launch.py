...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("max_speed", default_value="254"),
            DeclareLaunchArgument("min_speed", default_value="200"),
            DeclareLaunchArgument("max_linear_speed", default_value="0.48"),
            ...
            DeclareLaunchArgument("center_zone_width", default_value="0.18"),
            DeclareLaunchArgument("turn_response", default_value="0.4"),
            DeclareLaunchArgument("smoothing_factor", default_value="0.15"),
            DeclareLaunchArgument("min_turn_threshold", default_value="0.05"),
            Node(
                ...
                parameters=[
                    config_file,
                    {
                        ...
                        "center_zone_width": LaunchConfiguration("center_zone_width"),
                        "turn_response": LaunchConfiguration("turn_response"),
                        "smoothing_factor": LaunchConfiguration("smoothing_factor"),
                        "min_turn_threshold": LaunchConfiguration("min_turn_threshold"),
                    },
                ],
            ),
            Node(
