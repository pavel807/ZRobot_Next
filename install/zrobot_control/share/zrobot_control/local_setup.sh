...
: ${AMENT_CURRENT_PREFIX:="/root/ws_ros2/ZRobot_Next/install/zrobot_control"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/zrobot_control/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/zrobot_control/environment/path.sh"
