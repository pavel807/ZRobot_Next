...
: ${AMENT_CURRENT_PREFIX:="/root/ws_ros2/ZRobot_Next/install/zrobot_obstacle_avoidance"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/zrobot_obstacle_avoidance/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/zrobot_obstacle_avoidance/environment/path.sh"
