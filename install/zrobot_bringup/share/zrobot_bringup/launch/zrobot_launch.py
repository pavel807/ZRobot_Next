...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("max_speed", default_value="255"),
            DeclareLaunchArgument("min_speed_left", default_value="80"),
            DeclareLaunchArgument("min_speed_right", default_value="100"),
            DeclareLaunchArgument("max_linear_speed", default_value="0.07"),
            DeclareLaunchArgument("turn_speed", default_value="1.0"),
            DeclareLaunchArgument("search_delay_sec", default_value="15"),
            ...
            Node(
                ...
                parameters=[
                    config_file,
                    {
                        ...
                        "min_speed_left": LaunchConfiguration("min_speed_left"),
                        "min_speed_right": LaunchConfiguration("min_speed_right"),
                    },
                ],
            ),
            Node(
